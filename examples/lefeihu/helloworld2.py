...
#region Setup and check the images you have just added
import requests
import glob
...
#region Settings for your newly created concept
...
#region Load the Stable Diffusion model
...
#region Setting up all training args
...
# hf_token_write = "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" #@param {type:"string"}
# if(save_concept):
